...
<p align="center"><strong>Professor of Medical AI · Builder of One Person Lab</strong></p>
<p align="center">
...
<p align="center">Building clinically grounded AI and the coordination infrastructure that turns research and professional knowledge work into recoverable, human-auditable systems across tasks, repositories, and machines.</p>

<p align="center">
  <a href="https://github.com/gaofeng21cn/one-person-lab"><strong>One Person Lab</strong></a>
  &nbsp;·&nbsp;
  <a href="https://github.com/gaofeng21cn/one-person-lab-app"><strong>OPL App</strong></a>
  &nbsp;·&nbsp;
  <a href="https://github.com/gaofeng21cn/opl-flow"><strong>OPL Flow</strong></a>
  &nbsp;·&nbsp;
...
<table>
  <tr>
    <td width="33%" valign="top" align="center">
      ...
      Runtime, activation, contracts, recovery, and projection across OPL packages.
    </td>
    <td width="33%" valign="top" align="center">
      ...
      The primary user entry point for desktop and browser work.
    </td>
    <td width="33%" valign="top" align="center">
...
<p align="center"><strong>Most users should start with One Person Lab App.</strong></p>
<p align="center">It packages the OPL workbench, runtime, professional agents, and companion tools behind one product entry point. No separate Codex setup is required before getting started.</p>

<p align="center">
  <a href="https://github.com/gaofeng21cn/one-person-lab-app/releases/latest"><strong>Download OPL App</strong></a>
  &nbsp;·&nbsp;
  <a href="https://github.com/gaofeng21cn/one-person-lab-app/blob/main/docs/delivery/install/README.md">Installation Guide</a>
  &nbsp;·&nbsp;
  <a href="https://github.com/gaofeng21cn/one-person-lab-app/blob/main/docs/delivery/install/README.zh-CN.md">中文安装指南</a>
</p>

## Foundry Ecosystem

- **Agent Foundry** · [OPL Meta Agent](https://github.com/gaofeng21cn/opl-meta-agent) builds, tests, and improves OPL-compatible agents.
- **Grant Foundry** · [Med Auto Grant](https://github.com/gaofeng21cn/med-autogrant) supports proposal direction, drafting, review, and package export.
